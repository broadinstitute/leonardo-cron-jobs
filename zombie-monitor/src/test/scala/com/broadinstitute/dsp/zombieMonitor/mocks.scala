...
import com.broadinstitute.dsp.{Disk, GceGalaxyCluster, KubernetesCluster, Nodepool}
import fs2.Stream
...
class FakeDbReader extends DbReader[IO] {
  ...
  override def getGceGalaxyClustersToDeleteCandidate: Stream[IO, GceGalaxyCluster] = Stream.empty
